...
export default function JamsPage() {
  return <div className="min-h-screen text-[#1f2d3d] bg-[#F5F5F5] relative">
    ...
    <div className="px-4 py-4 container max-w-6xl">
    ...
    <main className="px-4 container max-w-6xl flex flex-col md:flex-row gap-12">      
      <div className="flex-1 md:pb-36">
        <div className="aspect-video rounded-3xl bg-purple-300"></div>
      ...
      <div className="md:w-80 pb-12 relative">
